# Statistiques - doc20260115223525

## 📊 Vue d'ensemble

- **Nombre total de copies**: 5
- **Moyenne ancienne correction**: 11.20/20
- **Moyenne nouvelle correction**: 16.80/20
- **Différence moyenne**: +5.60 points
- **Copies avec amélioration**: 4 (80.0%)

## 📈 Analyse

La nouvelle approche encourageante a permis d'augmenter la moyenne de **5.60 points** en moyenne.
